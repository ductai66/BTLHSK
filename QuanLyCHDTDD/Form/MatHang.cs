    ...
    public partial class MatHang : Form
    {
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    tim_sql = tim_sql + "select sMaMH as [Mã mặt hàng], sTenMH as [Tên mặt hàng],iSoluong as [Số lượng],sThoigianbaohanh as [Thời gian BH]," +
                        "fGiahang as [Giá hàng], sTenLH as [Tên loại hàng] from tblMatHang,tblLoaiHang where tblMatHang.sMaLH = tblLoaiHang.sMaLH AND sMaMH = N'" + txtNhapmaMH.Text + "' ";
